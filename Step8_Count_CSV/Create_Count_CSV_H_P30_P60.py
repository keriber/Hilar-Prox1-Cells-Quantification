...
path = "F:\Backup Seagate Hardrive\Quantification_C57_SW\Quantification_Default_GCL_H\Default\C57_21_p30_C_H"
path2 = "F:\Backup Seagate Hardrive\Quantification_C57_SW\Quantification_Default_GCL_H\Hilus_CSV_copy"
name = 'C57_21_p30_C_H'
...
Table.to_csv(name + '_Hilus_cell_count'+'.csv')
os.chdir(path2)
Table.to_csv(name + '_Hilus_cell_count'+'.csv')
