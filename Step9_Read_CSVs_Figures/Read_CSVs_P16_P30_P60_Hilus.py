...
for i in TotalCells.columns:
    if re.search('C57', i) and re.search('p16',i):
        C57_p16.append(i)
...
Groups = [C57_p16, C57_p30, C57, SW_p30 ,SW ]
SGroup = ['C57_p16','C57_p30','C57', 'SW_p30' ,'SW' ]
...
TotalCells.to_csv('C:\Users\keriambermudez\Dropbox\Figures\Figure2  p16 p30 p60 Septotemporal\Hilus\Total_Cells_C57_SW_Hilus.csv')
HilusArea.to_csv('C:\Users\keriambermudez\Dropbox\Figures\Figure2  p16 p30 p60 Septotemporal\Hilus\HilusArea_C57_SW_Hilus.csv')
TotalCells_Area.to_csv('C:\Users\keriambermudez\Dropbox\Figures\Figure2  p16 p30 p60 Septotemporal\Hilus\Total_Cells_Area_C57_SW_Hilus.csv')
